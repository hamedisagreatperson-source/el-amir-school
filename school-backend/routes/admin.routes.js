...
router.patch('/students/:id/approve', permissionGuard('manage_students'), ctrl.approveStudent);
...
router.post('/teachers/:id/impersonate', roleGuard('super_admin'), ctrl.impersonateTeacher);
