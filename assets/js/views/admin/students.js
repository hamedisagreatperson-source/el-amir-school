const AdminStudents = (() => {
  ...
  return { render, showAddModal, submitAddStudent, viewStudent, editStudent, submitEditStudent, deleteStudent, onSearch, filterLevel, filterStatus, exportExcel, exportPDF };
})();
