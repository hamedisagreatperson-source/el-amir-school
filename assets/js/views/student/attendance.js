    ...
    try {
      ...
      page.innerHTML = `
        <div class="grid grid-4 mb-24 stagger">
          <div class="stat-card"><div class="stat-icon blue">&#128218;</div><div><div class="stat-value">${s.total}</div><div class="stat-label">إجمالي الحصص</div></div></div>
          <div class="stat-card"><div class="stat-icon green">&#9989;</div><div><div class="stat-value">${s.present}</div><div class="stat-label">حاضر</div></div></div>
          <div class="stat-card"><div class="stat-icon red">&#10007;</div><div><div class="stat-value">${s.absent}</div><div class="stat-label">غائب</div></div></div>
          <div class="stat-card"><div class="stat-icon gold">&#128202;</div><div><div class="stat-value">${s.rate}%</div><div class="stat-label">النسبة</div></div></div>
        </div>
